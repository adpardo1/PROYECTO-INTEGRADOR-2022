...
LOAD DATA INFILE 'D:\\DATOS(csv)\\establecimiento.csv'
...
-- Datos servicios
LOAD DATA INFILE 'D:\\DATOS(csv)\\servicios.csv'
...
-- Datos categoria
LOAD DATA INFILE 'D:\\DATOS(csv)\\categoria.csv'
...
-- Datos idioma
LOAD DATA INFILE 'D:\\DATOS(csv)\\idioma.csv'
...
-- Datos provincia
LOAD DATA INFILE 'D:\\DATOS(csv)\\provincia.csv'
...
-- Datos parroquia
  LOAD DATA INFILE 'D:\\DATOS(csv)\\parroquia.csv'
...
-- Datos canton
 LOAD DATA INFILE 'D:\\DATOS(csv)\\canton.csv'
...
-- Datos esta_provin
 LOAD DATA INFILE 'D:\\DATOS(csv)\\esta_provin.csv'
